...
```{r Chart1, fig.width=7, fig.height=6,echo=TRUE}
...
```{r Chart2, fig.width=7, fig.height=6,echo=TRUE}
...
```{r Chart3, fig.width=7, fig.height=6,echo=TRUE}
...
```{r Chart4,fig.width=8, fig.height=8,echo=TRUE}
par(mfrow = c(2, 1))
par(cex = 0.6)
par(mar = c(1, 1,1.5,1)) 
par(col="blue")
...
plot(byWeekday, type='l',ylab="Steps",xlab="Time in 5 Minute Increments",main="Weekday") 
```
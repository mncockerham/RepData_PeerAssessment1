...
- next I am adding a column called Ind that will show if it is a weekday or weekend, I am setting all values to 0
- 0 will be the value for a weekday so I do not need to change anything
- 1 will be for weekend and I need to update all entries for both Saturday and Sunday and set them to 1
